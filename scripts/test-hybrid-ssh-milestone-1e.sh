...
go test ./internal/config -run 'TestGeneratedConfigV2WriteGatePersistsDaemonStartMigration|TestInternalTestProfilePersistsConfigV2GeneratedListenMigration'
go test ./internal/daemon -run TestGeneratedPeerHTTPRuntimeGateSkipsFanout

(cd apps/mac/Clipfan && swift test --filter GeneratedConfigV2WriteGateEnablesDefaultDowngradeBlock)
